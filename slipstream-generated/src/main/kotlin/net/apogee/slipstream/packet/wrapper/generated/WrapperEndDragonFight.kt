...
value class WrapperEndDragonFight(val handle: Any) {
    companion object {
        ...
        val tryRespawnHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "tryRespawn", MethodType.methodType(Boolean::class.javaPrimitiveType!!, Class.forName("net.minecraft.core.BlockPos")))
        }
    ...
    fun tryRespawn(arg0: WrapperBlockPos): Boolean {
        return tryRespawnHandle.invoke(handle, arg0.handle) as Boolean
    }
