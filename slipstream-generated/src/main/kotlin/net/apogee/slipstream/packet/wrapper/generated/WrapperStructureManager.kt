...
value class WrapperStructureManager(val handle: Any) {
    companion object {
        ...
        val getStructureWithPieceAtHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "getStructureWithPieceAt", MethodType.methodType(Class.forName("net.minecraft.world.level.levelgen.structure.StructureStart"), Class.forName("net.minecraft.core.BlockPos"), Class.forName("net.minecraft.core.HolderSet")))
        }
        val startsForStructureHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "startsForStructure", MethodType.methodType(Class.forName("java.util.List"), Class.forName("net.minecraft.world.level.ChunkPos"), Class.forName("java.util.function.Predicate")))
        }
    ...
    fun getStructureWithPieceAt(arg0: WrapperBlockPos, arg1: WrapperHolderSet): WrapperStructureStart {
        return WrapperStructureStart(getStructureWithPieceAtHandle.invoke(handle, arg0.handle, arg1.handle))
    }

    fun startsForStructure(arg0: WrapperChunkPos, arg1: Any): Any {
        return startsForStructureHandle.invoke(handle, arg0.handle, arg1) as Any
    }
