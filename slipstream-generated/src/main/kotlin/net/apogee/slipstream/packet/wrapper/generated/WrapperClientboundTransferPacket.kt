...
fun Any.isClientboundTransferPacket(): Boolean = WrapperClientboundTransferPacket.packetClass.isInstance(this)
fun Any.asClientboundTransferPacket(): WrapperClientboundTransferPacket = WrapperClientboundTransferPacket(this)
