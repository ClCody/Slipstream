...
value class WrapperLevel(val handle: Any) {
    companion object {
        ...
        val explodeHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "explode", MethodType.methodType(Class.forName("net.minecraft.world.level.Explosion"), Class.forName("net.minecraft.world.entity.Entity"), Class.forName("net.minecraft.world.damagesource.DamageSource"), Class.forName("net.minecraft.world.level.ExplosionDamageCalculator"), Double::class.javaPrimitiveType!!, Double::class.javaPrimitiveType!!, Double::class.javaPrimitiveType!!, Float::class.javaPrimitiveType!!, Boolean::class.javaPrimitiveType!!, Class.forName("net.minecraft.world.level.Level\$ExplosionInteraction")))
        }
    ...
    fun explode(arg0: WrapperEntity, arg1: WrapperDamageSource, arg2: WrapperExplosionDamageCalculator, arg3: Double, arg4: Double, arg5: Double, arg6: Float, arg7: Boolean, arg8: Any): WrapperExplosion {
        return WrapperExplosion(explodeHandle.invoke(handle, arg0.handle, arg1.handle, arg2.handle, arg3, arg4, arg5, arg6, arg7, arg8))
    }
