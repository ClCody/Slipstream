...
value class WrapperDamageSources(val handle: Any) {
    companion object {
        ...
        val explosionHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "explosion", MethodType.methodType(Class.forName("net.minecraft.world.damagesource.DamageSource"), Class.forName("net.minecraft.world.level.Explosion")))
        }
        ...
        val badRespawnPointExplosionHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "badRespawnPointExplosion", MethodType.methodType(Class.forName("net.minecraft.world.damagesource.DamageSource"), Class.forName("net.minecraft.world.phys.Vec3")))
        }
    ...
    fun explosion(arg0: WrapperExplosion): WrapperDamageSource {
        return WrapperDamageSource(explosionHandle.invoke(handle, arg0.handle))
    }
    ...
    fun badRespawnPointExplosion(arg0: WrapperVec3): WrapperDamageSource {
        return WrapperDamageSource(badRespawnPointExplosionHandle.invoke(handle, arg0.handle))
    }
