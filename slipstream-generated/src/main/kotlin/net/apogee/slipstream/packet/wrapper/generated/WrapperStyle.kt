...
value class WrapperStyle(val handle: Any) {
    companion object {
        ...
        val withColorHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "withColor", MethodType.methodType(Class.forName("net.minecraft.network.chat.Style"), Int::class.javaPrimitiveType!!))
        }
    ...
    fun withColor(arg0: Int): WrapperStyle {
