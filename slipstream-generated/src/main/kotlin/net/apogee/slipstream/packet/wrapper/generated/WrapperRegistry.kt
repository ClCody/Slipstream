...
value class WrapperRegistry(val handle: Any) {
    companion object {
        ...
        val getHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "get", MethodType.methodType(Class.forName("java.lang.Object"), Class.forName("net.minecraft.resources.ResourceKey")))
        }
        ...
        val containsKeyHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "containsKey", MethodType.methodType(Boolean::class.javaPrimitiveType!!, Class.forName("net.minecraft.resources.ResourceLocation")))
        }
        ...
        val getHolderHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "getHolder", MethodType.methodType(Class.forName("java.util.Optional"), Class.forName("net.minecraft.resources.ResourceLocation")))
        }
    ...
    fun containsKey(arg0: WrapperResourceLocation): Boolean {
    ...
    fun getHolder(arg0: WrapperResourceLocation): Any {
        return getHolderHandle.invoke(handle, arg0.handle) as Any
    }
