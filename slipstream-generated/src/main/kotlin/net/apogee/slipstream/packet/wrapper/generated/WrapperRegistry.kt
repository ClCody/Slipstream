...
value class WrapperRegistry(val handle: Any) {
    companion object {
        ...
        val getHolderHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "getHolder", MethodType.methodType(Class.forName("java.util.Optional"), Class.forName("net.minecraft.resources.ResourceKey")))
        }
    ...
    fun getHolder(arg0: WrapperResourceKey): Any {
