...
@JvmInline
value class WrapperServerboundMoveVehiclePacket(val handle: Any) {
    companion object {
        val packetClass: Class<*> by lazy { Class.forName("net.minecraft.network.protocol.game.ServerboundMoveVehiclePacket") }
...
fun Any.isServerboundMoveVehiclePacket(): Boolean = WrapperServerboundMoveVehiclePacket.packetClass.isInstance(this)
fun Any.asServerboundMoveVehiclePacket(): WrapperServerboundMoveVehiclePacket = WrapperServerboundMoveVehiclePacket(this)
