...
value class WrapperPoiManager(val handle: Any) {
    companion object {
        ...
        val findClosestHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "findClosest", MethodType.methodType(Class.forName("java.util.Optional"), Class.forName("java.util.function.Predicate"), Class.forName("net.minecraft.core.BlockPos"), Int::class.javaPrimitiveType!!, Class.forName("net.minecraft.world.entity.ai.village.poi.PoiManager\$Occupancy")))
        }
    ...
    fun findClosest(arg0: Any, arg1: WrapperBlockPos, arg2: Int, arg3: Any): Any {
        return findClosestHandle.invoke(handle, arg0, arg1.handle, arg2, arg3) as Any
    }
