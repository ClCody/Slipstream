...
value class WrapperBlockGetter(val handle: Any) {
    companion object {
        ...
        val getBlockFloorHeightHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "getBlockFloorHeight", MethodType.methodType(Double::class.javaPrimitiveType!!, Class.forName("net.minecraft.world.phys.shapes.VoxelShape"), Class.forName("java.util.function.Supplier")))
        }
        ...
        val clipHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "clip", MethodType.methodType(Class.forName("net.minecraft.world.phys.BlockHitResult"), Class.forName("net.minecraft.world.level.ClipContext"), Class.forName("net.minecraft.core.BlockPos"), Class.forName("java.util.function.Predicate")))
        }
    ...
    fun getBlockFloorHeight(arg0: WrapperVoxelShape, arg1: Any): Double {
        return getBlockFloorHeightHandle.invoke(handle, arg0.handle, arg1) as Double
    }
    ...
    fun clip(arg0: WrapperClipContext, arg1: WrapperBlockPos, arg2: Any): WrapperBlockHitResult {
        return WrapperBlockHitResult(clipHandle.invoke(handle, arg0.handle, arg1.handle, arg2))
    }
