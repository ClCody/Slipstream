...
value class WrapperWorldGenRegion(val handle: Any) {
    companion object {
        ...
        val getEntitiesHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "getEntities", MethodType.methodType(Class.forName("java.util.List"), Class.forName("net.minecraft.world.entity.Entity"), Class.forName("net.minecraft.world.phys.AABB"), Class.forName("java.util.function.Predicate")))
        }
    ...
    fun getEntities(arg0: WrapperEntity, arg1: WrapperAABB, arg2: Any): Any {
