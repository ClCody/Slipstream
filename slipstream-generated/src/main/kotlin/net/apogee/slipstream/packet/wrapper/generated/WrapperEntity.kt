...
value class WrapperEntity(val handle: Any) {
    companion object {
        ...
        val spawnAtLocationHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "spawnAtLocation", MethodType.methodType(Class.forName("net.minecraft.world.entity.item.ItemEntity"), Class.forName("net.minecraft.world.level.ItemLike")))
        }
    ...
    fun spawnAtLocation(arg0: WrapperItemLike): WrapperItemEntity {
