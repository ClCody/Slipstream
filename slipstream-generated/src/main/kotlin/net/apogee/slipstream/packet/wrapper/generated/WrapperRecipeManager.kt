...
value class WrapperRecipeManager(val handle: Any) {
    companion object {
        ...
        val getRecipeForHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "getRecipeFor", MethodType.methodType(Class.forName("java.util.Optional"), Class.forName("net.minecraft.world.item.crafting.RecipeType"), Class.forName("net.minecraft.world.item.crafting.RecipeInput"), Class.forName("net.minecraft.world.level.Level"), Class.forName("net.minecraft.resources.ResourceLocation")))
        }
        ...
        val getRemainingItemsForHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "getRemainingItemsFor", MethodType.methodType(Class.forName("net.minecraft.core.NonNullList"), Class.forName("net.minecraft.world.item.crafting.RecipeType"), Class.forName("net.minecraft.world.item.crafting.RecipeInput"), Class.forName("net.minecraft.world.level.Level"), Class.forName("net.minecraft.world.item.crafting.RecipeHolder")))
        }
    ...
    fun getRecipeFor(arg0: Any, arg1: WrapperRecipeInput, arg2: WrapperLevel, arg3: WrapperResourceLocation): Any {
    ...
    fun getRemainingItemsFor(arg0: Any, arg1: WrapperRecipeInput, arg2: WrapperLevel, arg3: WrapperRecipeHolder): WrapperNonNullList {
        return WrapperNonNullList(getRemainingItemsForHandle.invoke(handle, arg0, arg1.handle, arg2.handle, arg3.handle))
    }
