...
value class WrapperRecipeManager(val handle: Any) {
    companion object {
        ...
        val getRecipeForHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "getRecipeFor", MethodType.methodType(Class.forName("java.util.Optional"), Class.forName("net.minecraft.world.item.crafting.RecipeType"), Class.forName("net.minecraft.world.item.crafting.RecipeInput"), Class.forName("net.minecraft.world.level.Level")))
        }
    ...
    fun getRecipeFor(arg0: Any, arg1: WrapperRecipeInput, arg2: WrapperLevel): Any {
        return getRecipeForHandle.invoke(handle, arg0, arg1.handle, arg2.handle) as Any
    }
