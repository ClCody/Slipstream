...
@JvmInline
value class WrapperPacked(val handle: Any) {
    companion object {
        val packetClass: Class<*> by lazy { Class.forName("net.minecraft.network.chat.LastSeenMessages\$Packed") }
    ...
    fun copy(entries: Any = this.entries): WrapperPacked {
        return WrapperPacked(constructorHandle.invoke(entries))
    }
