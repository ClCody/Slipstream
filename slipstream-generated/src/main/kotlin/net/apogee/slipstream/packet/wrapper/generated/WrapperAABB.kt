...
value class WrapperAABB(val handle: Any) {
    companion object {
        ...
        val intersectsHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "intersects", MethodType.methodType(Boolean::class.javaPrimitiveType!!, Class.forName("net.minecraft.world.phys.Vec3"), Class.forName("net.minecraft.world.phys.Vec3")))
        }
        ...
        val deflateHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "deflate", MethodType.methodType(Class.forName("net.minecraft.world.phys.AABB"), Double::class.javaPrimitiveType!!, Double::class.javaPrimitiveType!!, Double::class.javaPrimitiveType!!))
        }
    ...
    fun intersects(arg0: WrapperVec3, arg1: WrapperVec3): Boolean {
        return intersectsHandle.invoke(handle, arg0.handle, arg1.handle) as Boolean
    }
    ...
    fun deflate(arg0: Double, arg1: Double, arg2: Double): WrapperAABB {
        return WrapperAABB(deflateHandle.invoke(handle, arg0, arg1, arg2))
    }
