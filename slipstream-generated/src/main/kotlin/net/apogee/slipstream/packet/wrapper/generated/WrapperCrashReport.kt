...
value class WrapperCrashReport(val handle: Any) {
    companion object {
        ...
        val addCategoryHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "addCategory", MethodType.methodType(Class.forName("net.minecraft.CrashReportCategory"), String::class.java))
        }
    ...
    fun addCategory(arg0: String): WrapperCrashReportCategory {
        return WrapperCrashReportCategory(addCategoryHandle.invoke(handle, arg0))
    }
