...
value class WrapperServerLevel(val handle: Any) {
    companion object {
        ...
        val strikeLightningHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "strikeLightning", MethodType.methodType(Boolean::class.javaPrimitiveType!!, Class.forName("net.minecraft.world.entity.Entity")))
        }
        ...
        val isVillageHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "isVillage", MethodType.methodType(Boolean::class.javaPrimitiveType!!, Class.forName("net.minecraft.core.SectionPos")))
        }
        ...
        val getEntitiesHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "getEntities", MethodType.methodType(Class.forName("java.util.List"), Class.forName("net.minecraft.world.level.entity.EntityTypeTest"), Class.forName("java.util.function.Predicate")))
        }
        ...
        val isNaturalSpawningAllowedHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "isNaturalSpawningAllowed", MethodType.methodType(Boolean::class.javaPrimitiveType!!, Class.forName("net.minecraft.core.BlockPos")))
        }
    ...
    fun strikeLightning(arg0: WrapperEntity): Boolean {
        return strikeLightningHandle.invoke(handle, arg0.handle) as Boolean
    }
    ...
    fun isVillage(arg0: WrapperSectionPos): Boolean {
    ...
    fun getEntities(arg0: WrapperEntityTypeTest, arg1: Any): Any {
        return getEntitiesHandle.invoke(handle, arg0.handle, arg1) as Any
    }
    ...
    fun isNaturalSpawningAllowed(arg0: WrapperBlockPos): Boolean {
