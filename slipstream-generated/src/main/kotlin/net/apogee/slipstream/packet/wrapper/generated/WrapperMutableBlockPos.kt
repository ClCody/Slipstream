...
value class WrapperMutableBlockPos(val handle: Any) {
    companion object {
        ...
        val setHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "set", MethodType.methodType(Class.forName("net.minecraft.core.BlockPos\$MutableBlockPos"), Class.forName("net.minecraft.core.Vec3i")))
        }
        ...
        val moveHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "move", MethodType.methodType(Class.forName("net.minecraft.core.BlockPos\$MutableBlockPos"), Int::class.javaPrimitiveType!!, Int::class.javaPrimitiveType!!, Int::class.javaPrimitiveType!!))
        }
        ...
        val setWithOffsetHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "setWithOffset", MethodType.methodType(Class.forName("net.minecraft.core.BlockPos\$MutableBlockPos"), Class.forName("net.minecraft.core.Vec3i"), Class.forName("net.minecraft.core.Direction")))
        }
    ...
    fun set(arg0: WrapperVec3i): WrapperMutableBlockPos {
        return WrapperMutableBlockPos(setHandle.invoke(handle, arg0.handle))
    }
    ...
    fun move(arg0: Int, arg1: Int, arg2: Int): WrapperMutableBlockPos {
        return WrapperMutableBlockPos(moveHandle.invoke(handle, arg0, arg1, arg2))
    }
    ...
    fun setWithOffset(arg0: WrapperVec3i, arg1: Any): WrapperMutableBlockPos {
        return WrapperMutableBlockPos(setWithOffsetHandle.invoke(handle, arg0.handle, arg1))
    }
