...
value class WrapperMutableBlockPos(val handle: Any) {
    companion object {
        ...
        val setHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "set", MethodType.methodType(Class.forName("net.minecraft.core.BlockPos\$MutableBlockPos"), Class.forName("net.minecraft.core.AxisCycle"), Int::class.javaPrimitiveType!!, Int::class.javaPrimitiveType!!, Int::class.javaPrimitiveType!!))
        }
    ...
    fun set(arg0: Any, arg1: Int, arg2: Int, arg3: Int): WrapperMutableBlockPos {
        return WrapperMutableBlockPos(setHandle.invoke(handle, arg0, arg1, arg2, arg3))
    }
