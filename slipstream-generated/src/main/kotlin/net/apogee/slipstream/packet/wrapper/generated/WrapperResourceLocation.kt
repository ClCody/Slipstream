...
value class WrapperResourceLocation(val handle: Any) {
    companion object {
        ...
        val withPathHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "withPath", MethodType.methodType(Class.forName("net.minecraft.resources.ResourceLocation"), Class.forName("java.util.function.UnaryOperator")))
        }
    ...
    fun withPath(arg0: Any): WrapperResourceLocation {
