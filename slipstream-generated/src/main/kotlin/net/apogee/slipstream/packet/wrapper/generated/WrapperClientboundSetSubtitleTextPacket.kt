...
value class WrapperClientboundSetSubtitleTextPacket(val handle: Any) {
    ...
    fun copy(text: WrapperComponent = this.text): WrapperClientboundSetSubtitleTextPacket {
        return WrapperClientboundSetSubtitleTextPacket(constructorHandle.invoke(text.handle))
    }
