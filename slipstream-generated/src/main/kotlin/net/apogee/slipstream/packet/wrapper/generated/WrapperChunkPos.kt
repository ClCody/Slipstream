...
value class WrapperChunkPos(val handle: Any) {
    companion object {
        ...
        val distanceSquaredHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "distanceSquared", MethodType.methodType(Int::class.javaPrimitiveType!!, Long::class.javaPrimitiveType!!))
        }
        ...
        val getChessboardDistanceHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "getChessboardDistance", MethodType.methodType(Int::class.javaPrimitiveType!!, Class.forName("net.minecraft.world.level.ChunkPos")))
        }
    ...
    fun distanceSquared(arg0: Long): Int {
        return distanceSquaredHandle.invoke(handle, arg0) as Int
    }
    ...
    fun getChessboardDistance(arg0: WrapperChunkPos): Int {
        return getChessboardDistanceHandle.invoke(handle, arg0.handle) as Int
    }
