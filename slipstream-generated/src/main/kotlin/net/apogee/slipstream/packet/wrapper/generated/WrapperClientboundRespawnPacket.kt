...
fun Any.isClientboundRespawnPacket(): Boolean = WrapperClientboundRespawnPacket.packetClass.isInstance(this)
fun Any.asClientboundRespawnPacket(): WrapperClientboundRespawnPacket = WrapperClientboundRespawnPacket(this)
