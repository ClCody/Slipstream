...
value class WrapperServerChunkCache(val handle: Any) {
    companion object {
        ...
        val isPositionTickingHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "isPositionTicking", MethodType.methodType(Boolean::class.javaPrimitiveType!!, Long::class.javaPrimitiveType!!))
        }
    ...
    fun isPositionTicking(arg0: Long): Boolean {
        return isPositionTickingHandle.invoke(handle, arg0) as Boolean
    }
