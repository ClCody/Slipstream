...
value class WrapperEntityType(val handle: Any) {
    companion object {
        ...
        val spawnHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "spawn", MethodType.methodType(Class.forName("net.minecraft.world.entity.Entity"), Class.forName("net.minecraft.server.level.ServerLevel"), Class.forName("java.util.function.Consumer"), Class.forName("net.minecraft.core.BlockPos"), Class.forName("net.minecraft.world.entity.MobSpawnType"), Boolean::class.javaPrimitiveType!!, Boolean::class.javaPrimitiveType!!, Class.forName("org.bukkit.event.entity.CreatureSpawnEvent\$SpawnReason")))
        }
    ...
    fun spawn(arg0: WrapperServerLevel, arg1: Any, arg2: WrapperBlockPos, arg3: Any, arg4: Boolean, arg5: Boolean, arg6: Any): WrapperEntity {
        return WrapperEntity(spawnHandle.invoke(handle, arg0.handle, arg1, arg2.handle, arg3, arg4, arg5, arg6))
    }
