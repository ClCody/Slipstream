...
value class WrapperStreamTagVisitor(val handle: Any) {
    companion object {
        ...
        val visitEntryHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "visitEntry", MethodType.methodType(Class.forName("net.minecraft.nbt.StreamTagVisitor\$EntryResult"), Class.forName("net.minecraft.nbt.TagType")))
        }
    }
    ...
    fun visitEntry(arg0: WrapperTagType): Any {
        return visitEntryHandle.invoke(handle, arg0.handle) as Any
    }
