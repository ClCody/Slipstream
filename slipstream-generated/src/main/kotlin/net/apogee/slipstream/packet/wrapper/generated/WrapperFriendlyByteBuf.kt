...
value class WrapperFriendlyByteBuf(val handle: Any) {
    companion object {
        ...
        val getBytesHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "getBytes", MethodType.methodType(Class.forName("net.minecraft.network.FriendlyByteBuf"), Int::class.javaPrimitiveType!!, Class.forName("io.netty.buffer.ByteBuf"), Int::class.javaPrimitiveType!!, Int::class.javaPrimitiveType!!))
        }
        ...
        val capacityHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "capacity", MethodType.methodType(Int::class.javaPrimitiveType!!))
        }
        val releaseHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "release", MethodType.methodType(Boolean::class.javaPrimitiveType!!, Int::class.javaPrimitiveType!!))
        }
        ...
        val readBytesHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "readBytes", MethodType.methodType(Class.forName("net.minecraft.network.FriendlyByteBuf"), Class.forName("io.netty.buffer.ByteBuf"), Int::class.javaPrimitiveType!!))
        }
        val writeBytesHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "writeBytes", MethodType.methodType(Class.forName("net.minecraft.network.FriendlyByteBuf"), Class.forName("java.nio.ByteBuffer")))
        }
        ...
        val readerIndexHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "readerIndex", MethodType.methodType(Int::class.javaPrimitiveType!!))
        }
        ...
        val readMapHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "readMap", MethodType.methodType(Class.forName("java.util.Map"), Class.forName("java.util.function.IntFunction"), Class.forName("net.minecraft.network.codec.StreamDecoder"), Class.forName("net.minecraft.network.codec.StreamDecoder")))
        }
        ...
        val writeUtfHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "writeUtf", MethodType.methodType(Class.forName("net.minecraft.network.FriendlyByteBuf"), String::class.java, Int::class.javaPrimitiveType!!))
        }
        ...
        val setBytesHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "setBytes", MethodType.methodType(Class.forName("net.minecraft.network.FriendlyByteBuf"), Int::class.javaPrimitiveType!!, ByteArray::class.java))
        }
    ...
    fun getBytes(arg0: Int, arg1: Any, arg2: Int, arg3: Int): WrapperFriendlyByteBuf {
        return WrapperFriendlyByteBuf(getBytesHandle.invoke(handle, arg0, arg1, arg2, arg3))
    }
    ...
    val capacity: Int
        get() = capacityHandle.invoke(handle) as Int

    fun release(arg0: Int): Boolean {
        return releaseHandle.invoke(handle, arg0) as Boolean
    }
    ...
    fun readBytes(arg0: Any, arg1: Int): WrapperFriendlyByteBuf {
        return WrapperFriendlyByteBuf(readBytesHandle.invoke(handle, arg0, arg1))
    }
    ...
    val readerIndex: Int
        get() = readerIndexHandle.invoke(handle) as Int
    ...
    fun readMap(arg0: Any, arg1: WrapperStreamDecoder, arg2: WrapperStreamDecoder): Any {
        return readMapHandle.invoke(handle, arg0, arg1.handle, arg2.handle) as Any
    }
    ...
    fun writeUtf(arg0: String, arg1: Int): WrapperFriendlyByteBuf {
        return WrapperFriendlyByteBuf(writeUtfHandle.invoke(handle, arg0, arg1))
    }
    ...
    fun setBytes(arg0: Int, arg1: ByteArray): WrapperFriendlyByteBuf {
