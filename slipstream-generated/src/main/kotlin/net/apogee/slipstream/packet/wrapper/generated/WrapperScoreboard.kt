...
value class WrapperScoreboard(val handle: Any) {
    companion object {
        ...
        val getOrCreatePlayerScoreHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "getOrCreatePlayerScore", MethodType.methodType(Class.forName("net.minecraft.world.scores.ScoreAccess"), Class.forName("net.minecraft.world.scores.ScoreHolder"), Class.forName("net.minecraft.world.scores.Objective")))
        }
    ...
    fun getOrCreatePlayerScore(arg0: WrapperScoreHolder, arg1: WrapperObjective): WrapperScoreAccess {
        return WrapperScoreAccess(getOrCreatePlayerScoreHandle.invoke(handle, arg0.handle, arg1.handle))
    }
