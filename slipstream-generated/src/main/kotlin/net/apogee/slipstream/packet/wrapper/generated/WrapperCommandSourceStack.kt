...
value class WrapperCommandSourceStack(val handle: Any) {
    companion object {
        ...
        val facingHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "facing", MethodType.methodType(Class.forName("net.minecraft.commands.CommandSourceStack"), Class.forName("net.minecraft.world.entity.Entity"), Class.forName("net.minecraft.commands.arguments.EntityAnchorArgument\$Anchor")))
        }
    ...
    fun facing(arg0: WrapperEntity, arg1: Any): WrapperCommandSourceStack {
        return WrapperCommandSourceStack(facingHandle.invoke(handle, arg0.handle, arg1))
    }
