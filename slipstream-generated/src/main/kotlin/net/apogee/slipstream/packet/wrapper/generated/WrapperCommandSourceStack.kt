...
value class WrapperCommandSourceStack(val handle: Any) {
    companion object {
        ...
        val withCallbackHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "withCallback", MethodType.methodType(Class.forName("net.minecraft.commands.CommandSourceStack"), Class.forName("net.minecraft.commands.CommandResultCallback")))
        }
        ...
        val hasPermissionHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "hasPermission", MethodType.methodType(Boolean::class.javaPrimitiveType!!, Int::class.javaPrimitiveType!!, String::class.java))
        }
    ...
    fun withCallback(arg0: Any): WrapperCommandSourceStack {
        return WrapperCommandSourceStack(withCallbackHandle.invoke(handle, arg0))
    }
    ...
    fun hasPermission(arg0: Int, arg1: String): Boolean {
        return hasPermissionHandle.invoke(handle, arg0, arg1) as Boolean
    }
