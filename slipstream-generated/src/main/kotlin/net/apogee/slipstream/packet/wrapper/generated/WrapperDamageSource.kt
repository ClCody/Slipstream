...
value class WrapperDamageSource(val handle: Any) {
    companion object {
        ...
        val directBlockHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "directBlock", MethodType.methodType(Class.forName("net.minecraft.world.damagesource.DamageSource"), Class.forName("net.minecraft.world.level.Level"), Class.forName("net.minecraft.core.BlockPos")))
        }
    ...
    fun directBlock(arg0: WrapperLevel, arg1: WrapperBlockPos): WrapperDamageSource {
        return WrapperDamageSource(directBlockHandle.invoke(handle, arg0.handle, arg1.handle))
    }
