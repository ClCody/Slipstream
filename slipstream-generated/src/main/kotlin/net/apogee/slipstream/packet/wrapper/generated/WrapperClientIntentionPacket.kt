...
fun Any.isClientIntentionPacket(): Boolean = WrapperClientIntentionPacket.packetClass.isInstance(this)
fun Any.asClientIntentionPacket(): WrapperClientIntentionPacket = WrapperClientIntentionPacket(this)
