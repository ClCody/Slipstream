...
value class WrapperLivingEntity(val handle: Any) {
    companion object {
        ...
        val addEffectHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "addEffect", MethodType.methodType(Boolean::class.javaPrimitiveType!!, Class.forName("net.minecraft.world.effect.MobEffectInstance"), Class.forName("net.minecraft.world.entity.Entity")))
        }
    ...
    fun addEffect(arg0: WrapperMobEffectInstance, arg1: WrapperEntity): Boolean {
        return addEffectHandle.invoke(handle, arg0.handle, arg1.handle) as Boolean
    }
