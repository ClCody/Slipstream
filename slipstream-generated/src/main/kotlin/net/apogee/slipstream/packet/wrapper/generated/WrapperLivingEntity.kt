...
value class WrapperLivingEntity(val handle: Any) {
    companion object {
        ...
        val addEffectHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "addEffect", MethodType.methodType(Boolean::class.javaPrimitiveType!!, Class.forName("net.minecraft.world.effect.MobEffectInstance"), Class.forName("net.minecraft.world.entity.Entity"), Class.forName("org.bukkit.event.entity.EntityPotionEffectEvent\$Cause")))
        }
        ...
        val removeAllEffectsHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "removeAllEffects", MethodType.methodType(Boolean::class.javaPrimitiveType!!))
        }
        ...
        val removeEffectHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "removeEffect", MethodType.methodType(Boolean::class.javaPrimitiveType!!, Class.forName("net.minecraft.core.Holder"), Class.forName("org.bukkit.event.entity.EntityPotionEffectEvent\$Cause")))
        }
        ...
        val randomTeleportHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "randomTeleport", MethodType.methodType(Boolean::class.javaPrimitiveType!!, Double::class.javaPrimitiveType!!, Double::class.javaPrimitiveType!!, Double::class.javaPrimitiveType!!, Boolean::class.javaPrimitiveType!!))
        }
        ...
        val removeEffectNoUpdateHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "removeEffectNoUpdate", MethodType.methodType(Class.forName("net.minecraft.world.effect.MobEffectInstance"), Class.forName("net.minecraft.core.Holder")))
        }
        ...
        val isHoldingHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "isHolding", MethodType.methodType(Boolean::class.javaPrimitiveType!!, Class.forName("net.minecraft.world.item.Item")))
        }
        ...
        val eatHandle: MethodHandle by lazy { 
            lookup.findVirtual(packetClass, "eat", MethodType.methodType(Class.forName("net.minecraft.world.item.ItemStack"), Class.forName("net.minecraft.world.level.Level"), Class.forName("net.minecraft.world.item.ItemStack")))
        }
    ...
    fun addEffect(arg0: WrapperMobEffectInstance, arg1: WrapperEntity, arg2: Any): Boolean {
        return addEffectHandle.invoke(handle, arg0.handle, arg1.handle, arg2) as Boolean
    }
    ...
    val removeAllEffects: Boolean
        get() = removeAllEffectsHandle.invoke(handle) as Boolean
    ...
    fun removeEffect(arg0: WrapperHolder, arg1: Any): Boolean {
        return removeEffectHandle.invoke(handle, arg0.handle, arg1) as Boolean
    }
    ...
    fun randomTeleport(arg0: Double, arg1: Double, arg2: Double, arg3: Boolean): Boolean {
        return randomTeleportHandle.invoke(handle, arg0, arg1, arg2, arg3) as Boolean
    }
    ...
    fun removeEffectNoUpdate(arg0: WrapperHolder): WrapperMobEffectInstance {
        return WrapperMobEffectInstance(removeEffectNoUpdateHandle.invoke(handle, arg0.handle))
    }
    ...
    fun isHolding(arg0: WrapperItem): Boolean {
        return isHoldingHandle.invoke(handle, arg0.handle) as Boolean
    }
    ...
    fun eat(arg0: WrapperLevel, arg1: WrapperItemStack): WrapperItemStack {
        return WrapperItemStack(eatHandle.invoke(handle, arg0.handle, arg1.handle))
    }
